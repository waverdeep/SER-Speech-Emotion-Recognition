...
def get_mel_spectrogram_format(filepath, duration):
    signal, sample_rate = spectrogram_functions.load_wav_librosa(filepath, 16000)
...
class AudioDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x = get_mel_spectrogram_format(filepath=self.dataset[idx], duration=self.duration)
